...
def save_model_artifacts(
    ...
    manifest = {
        ...
        "load_example": "from src.phase3_step1_models import load_model_artifacts; artifacts = load_model_artifacts('models/phase3_vong3')",
        "caveats": [
...
The reusable model coefficients/policies are saved under `models/phase3_vong3/` by default:
...
artifacts = load_model_artifacts("models/phase3_vong3")
```
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--models-dir", type=Path, default=Path(__file__).resolve().parents[1] / "models" / "phase3_vong3")
